      ...
      <div className="pricing8-max-width thq-section-max-width">
        <div className="pricing8-section-title">
          <span className="pricing8-text100 thq-body-small">
            {props.content1 ?? (
              <Fragment>
                <span className="pricing8-text179">Pricing plans</span>
              </Fragment>
            )}
          </span>
            ...
            <div className="pricing8-column1 thq-card">
              ...
              <div className="pricing8-price10">
                <div className="pricing8-price11">
                  <p className="pricing8-text107 thq-body-large">
                    {props.plan1 ?? (
                      <Fragment>
                        <span className="pricing8-text197">Basic Package</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing8-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing8-text161">$199</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text162">$189/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing8-button14 thq-button-animated thq-button-outline">
                <span className="thq-body-small">
                  {props.plan1Action ?? (
                    <Fragment>
                      <span className="pricing8-text168">Buy Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column2 thq-card">
              ...
              <div className="pricing8-price12">
                <div className="pricing8-price13">
                  ...
                  <h3 className="pricing8-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing8-text184">$399</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text174">$379/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing8-button15 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan2Action ?? (
                    <Fragment>
                      <span className="pricing8-text180">Buy Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column3 thq-card">
              ...
              <div className="pricing8-price14">
                <div className="pricing8-price15">
                  <p className="pricing8-text122 thq-body-large">
                    {props.plan3 ?? (
                      <Fragment>
                        <span className="pricing8-text203">Luxury Package</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing8-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing8-text181">$599</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text170">$569/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing8-list3">
                  ...
                  <div className="pricing8-list-item18">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature2 ?? (
                        <Fragment>
                          <span className="pricing8-text206">
                            High-end home decor items
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <button className="pricing8-button16 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing8-text171">Buy Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing8-price16">
                <div className="pricing8-price17">
                  <span className="pricing8-text131 thq-body-large">
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing8-text155">Basic plan</span>
                      </Fragment>
                    )}
                  </span>
                  <h3 className="pricing8-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text186">$200/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text190">or $20 monthly</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <div className="pricing8-price18">
                <div className="pricing8-price19">
                  <span className="pricing8-text138 thq-body-large">
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing8-text198">Business plan</span>
                      </Fragment>
                    )}
                  </span>
                  <h3 className="pricing8-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text196">$299/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text205">or $29 monthly</span>
                      </Fragment>
                    )}
                  </span>
                </div>
            ...
            <div className="pricing8-column6 thq-card">
              ...
              <div className="pricing8-price20">
                <div className="pricing8-price21">
                  ...
                  <h3 className="pricing8-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text185">$499/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                  ...
                  <div className="pricing8-list-item30">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature21 ?? (
                        <Fragment>
                          <span className="pricing8-text159">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button19 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan3Action1 ?? (
                    <Fragment>
                      <span className="pricing8-text173">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
